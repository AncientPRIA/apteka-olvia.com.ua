...
<div class="blog_section">
    ...
    <div class="blog_section_top">
        ...
        @if(isset($posts[0]))
            ...
            $sizes = Img::img($sizes);
            $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_1', true);
            @endphp
            ...
            <div class="blog_section_col_right_top wow slideInDown" data-wow-delay="0.3">
                @if(isset($posts[1]))
                    @php
                        ...
                        $sizes = Img::img($sizes);
                        $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_2', true);
                    @endphp
            ...
            <div class="blog_section_col_right_footer">
                @if(isset($posts[2]))
                    @php
                        ...
                        $sizes = Img::img($sizes);
                        $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_3', true);
                    @endphp
...
{{--                            {{$item->excerpt}}--}}
                ...
                @if(isset($posts[3]))
                    @php
                        ...
                        $sizes = Img::img($sizes);
                        $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_4', true);
                    @endphp
            ...
            <div class="blog_section_col_right_top wow slideInDown" data-wow-delay="0.3">
                @if(isset($posts[4]))
                    @php
                        ...
                        $sizes = Img::img($sizes);
                        $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_5', true);
                    @endphp
                    <a href="{{route('blog').'/'.$item->get_path()}}" class="blog_section_item padding-30 padding-30 Background_Is_Picture">
                        {!! $picture !!}
                        <div class="blog_section_item_top">
            ...
            <div class="blog_section_col_right_footer">
                @if(isset($posts[5]))
                    @php
                        ...
                        $sizes = Img::img($sizes);
                        $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_6', true);
                    @endphp
                    <a href="{{route('blog').'/'.$item->get_path()}}" class="blog_section_item wow slideInUp padding-30 w-100 w-50 Background_Is_Picture" data-wow-delay="0.5">
                        {!! $picture !!}
                        <div class="blog_section_item_top">
...
{{--                                {{$item->excerpt}}--}}
                ...
                @if(isset($posts[6]))
                    @php
                        ...
                        $sizes = Img::img($sizes);
                        $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_7', true);
                    @endphp
                    <a href="{{route('blog').'/'.$item->get_path()}}" class="blog_section_item wow slideInRight padding-30 w-100 w-50 Background_Is_Picture" data-wow-delay="0.7">
                        {!! $picture !!}
                        <div class="blog_section_item_top">
...
{{--                                {{$item->excerpt}}--}}
        ...
        <div class="blog_section_col_left wow slideInRight" data-wow-delay="0.1">
            @if(isset($posts[7]))
                @php
                    $item = $posts[7];
                    $image = $item->image ?? '';
                    ...
                    $sizes = Img::img($sizes);
                    $picture = Img::picture_compose($sizes, $mappings, true, '', $item->title.'_'.$item->category->name.'_photo_8', true);
                @endphp
                <a href="{{route('blog').'/'.$item->get_path()}}" class="blog_section_item padding-30 padding-60 w-100 Background_Is_Picture">
                    {!! $picture !!}
                    <div class="blog_section_item_top">
